...
<style>
  ...
  .emoji {
    position: absolute;
    animation: floatDown 20s ease-out forwards;
  }
...
<main>
  <section class="header">
    ...
    <p class="bio">
      I am a college CSAI student studying Data Science and AI major. 
      I have experience in data scraping, data cleaning, and data visualization.
    </p>
  </section>
  ...
  <section class="cards-container">
    ...
    >
      <div class="card {flippedCards.saturn ? 'flip' : ''}">
        <div class="card-face front">
          My favorite Astronomy photo<br>Tap to explore!
        </div>
        <div class="card-face back">
  ...
  <section class="fun-facts">
    ...
    <div class="fun-fact">
      <strong>1. Landscape Photography</strong> - I love capturing the beauty of nature.
    </div>
    <div class="fun-fact">
      <strong>2. Coloring</strong> - I enjoy coloring pages.
    </div>
    <div class="fun-fact">
      <strong>3. Astronomy Enthusiast</strong> - I'm passionate about space exploration.     
